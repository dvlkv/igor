...
Imagine the probability of the specific part replacement, from 0 to 10. If it is greater than 4, design that so it can be swapped without rewriting any other logic.
